      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl border border-csu-red/20">
            ...
            O Ministério da Acção Social, Família e Promoção da Mulher, abreviadamente designado «MASFAMU», é a Departamento Ministerial Auxiliar do Titular do Poder Executivo que de acordo com os princípios, objectivos e prioridades definidos, tem como missão conceber, propor. promover e executar a política social relativa as pessoas e grupos da população em situação de vulnerabilidade, promover o desenvolvimento das comunidades, incluindo acções de combate a pobreza, bem como a defesa do bem-estar da família, promoção da mulher e garanta dos seus direitos, promoção da igualdade e equidade do gênero, e a coordenação, acompanhamento e fiscalização das ONG's que prossigam fins de protecção social.
            </p>
          </div>
        </div>
      </div>
    ...
    <section className="py-20 bg-gradient-to-br from-csu-red/5 via-csu-yellow/5 to-csu-red/10">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 mb-4">
            <div className="w-12 h-1 bg-csu-yellow rounded-full"></div>
            <h2 className="text-4xl font-bold text-csu-black">MASFAMU Angola</h2>
            <div className="w-12 h-1 bg-csu-yellow rounded-full"></div>
          </div>
          <p className="text-csu-black/70 text-lg max-w-2xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-xl p-6 shadow-lg border border-csu-red/20">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-csu-red/20 rounded-full flex items-center justify-center">
                  <svg className="w-6 h-6 text-csu-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-csu-black/70">
                Promover políticas e programas de proteção social, desenvolvimento familiar e empoderamento da mulher, garantindo a inclusão social e o bem-estar das famílias angolanas.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-csu-red/20">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-csu-yellow/20 rounded-full flex items-center justify-center">
                  <svg className="w-6 h-6 text-csu-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-csu-black/70">
                Ser uma referência na promoção da coesão social, igualdade de género e desenvolvimento sustentável das famílias em Angola.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-csu-red/20">
              ...
              <p className="text-csu-black/70">
                Solidariedade, equidade, transparência, responsabilidade social e respeito pelos direitos humanos e dignidade da pessoa humana.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl border border-csu-red/20 mb-12">
            <h3 className="text-2xl font-bold text-csu-black text-center mb-8">Áreas de Atuação</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-csu-black mb-2">Proteção Social</h4>
                  <p className="text-csu-black/70 text-sm">
                    Desenvolvimento e implementação de programas de assistência social, incluindo o CSU, para garantir a proteção dos grupos mais vulneráveis.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-csu-black mb-2">Desenvolvimento Familiar</h4>
                  <p className="text-csu-black/70 text-sm">
                    Promoção de políticas e programas que fortaleçam a estrutura familiar e melhorem a qualidade de vida das famílias angolanas.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-csu-black mb-2">Promoção da Mulher</h4>
                  <p className="text-csu-black/70 text-sm">
                    Empoderamento feminino, igualdade de género e promoção dos direitos das mulheres em todos os setores da sociedade.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-csu-black mb-2">Inclusão Social</h4>
                  <p className="text-csu-black/70 text-sm">
                    Desenvolvimento de políticas e programas que promovam a inclusão social e reduzam as desigualdades económicas e sociais.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-csu-red to-csu-red/90 rounded-2xl p-8 shadow-xl text-white">
            <h3 className="text-2xl font-bold text-center mb-6">Informações de Contacto</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80">Ministério da Ação Social, Família e Promoção da Mulher<br />
                  Luanda, Angola</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80">Telefone: +244 930 097 456<br />
                  Email: geral@masfamu.gov.ao</p>
                </div>
              </div>
            </div>
          </div>
