...
export default function Modal() {
  ...
  const handleDenunciaInputChange = (
    field: string,
    value: string | boolean | FileList | null
  ) => {
  ...
  const isDenunciaStepValid = (step: number) => {
    if (isAnonymous) {
      switch (step) {
        ...
        case 2:
          return (
            denunciaData.concelhoDenuncia &&
            denunciaData.descricaoDenuncia &&
            denunciaData.termosDenuncia
          );
        default:
          return false;
      }
      ...
      switch (step) {
        case 1:
          return (
            ...
            denunciaData.telefoneDenunciante &&
            denunciaData.sexoDenunciante &&
            denunciaData.dataNascimentoDenunciante
          );
        case 2:
          return (
            denunciaData.concelhoDenuncia &&
    ...
    <>
      ...
      <dialog id="modal-reclamacao" className="modal">
        <div className="modal-box w-11/12 max-w-3xl bg-white shadow-2xl p-4 sm:p-6 md:p-8">
          <form method="dialog">
            <button className="btn btn-sm btn-circle btn-ghost absolute right-4 top-4 hover:bg-gray-100">
              ✕
            </button>
          </form>
          ...
          <div className="text-center mb-6 sm:mb-8">
            <div className="flex items-center justify-center mb-4 flex-col sm:flex-row">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-csu-black text-center">
                ...
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                    <div className="form-control">
                      <label className="label pb-2 sm:pb-3">
                        <span className="label-text font-bold text-csu-black text-base sm:text-lg">
                          Nome do Reclamante *
                        </span>
                      </label>
                      <input
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="form-control">
                      <label className="label pb-3">
                        <span className="label-text font-bold text-csu-black text-lg">
                          Sexo *
                        </span>
                      </label>
                      <select
                    ...
                    <div className="form-control">
                      ...
                      <div className="relative">
                        ...
                        />
                        <svg
                          className="absolute right-4 top-1/2 transform -translate-y-1/2 w-6 h-6 text-csu-red/60"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                  ...
                  <div className="form-control">
                    <label className="label block pb-3">
                      <span className="label-text block font-bold text-csu-black text-lg">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="form-control">
                      ...
                      {/* <select
                        ...
                        onChange={(e) =>
                          handleInputChange("concelho", e.target.value)
                        }
                        required
                      >
                    ...
                    <div className="form-control">
                      ...
                      <input
                        ...
                        value={formData.zona}
                        onChange={(e) =>
                          handleInputChange("zona", e.target.value)
                        }
                        required
                      />
                      {/* <select 
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="form-control">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleInputChange("possuiCadastro", e.target.value)
                        }
                      >
                    ...
                    <div className="form-control">
                      ...
                      <input
                        ...
                        value={formData.nia}
                        onChange={(e) =>
                          handleInputChange("nia", e.target.value)
                        }
                      />
                    </div>
                  </div>
                      ...
                      <label className="label cursor-pointer">
                        <div className="flex items-start space-x-4">
                          <input
                            ...
                            onChange={(e) =>
                              handleInputChange("termos", e.target.checked)
                            }
                            required
                          />
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-wrap text-gray-600 mt-2">
                              Ao marcar esta opção, você concorda com o
                              processamento dos seus dados pessoais para fins de
                              análise e resolução da reclamação.
                            </p>
                          </div>
                        </div>
                      </label>
                ...
                {!isAnonymous && (
                  <div className="space-y-8">
                    ...
                    <div className="form-control">
                      <label className="label block pb-3">
                        <span className="label-text block font-bold text-csu-black text-lg">
                          Caso tenha, informe um email de contacto
                        </span>
                      </label>
                      <input
                        type="email"
                  ...
                  <div className="form-control">
                    ...
                    >
                      ...
                      <input
                        ...
                        value={denunciaData.concelhoDenuncia}
                        onChange={(e) =>
                          handleDenunciaInputChange("concelhoDenuncia", e.target.value)
                        }
                        required
                      />
                  </div>
                        ...
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-wrap text-gray-600 mt-2">
                              Ao marcar esta opção, você concorda com o
                              processamento dos seus dados pessoais para fins de
                              análise e resolução da denúncia.
                            </p>
                          </div>
                        </div>
                      </label>
