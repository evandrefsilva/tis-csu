  ...
  return (
    <section id="indicadores" className="py-20 bg-gradient-to-br from-csu-red via-red-700 to-red-900 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center">
          <button className="btn flex flex-row items-center justify-center mx-auto bg-csu-white hover:bg-csu-white/90 text-csu-black border-none px-8 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
